...
/* harmony import */ var _quicktasksview_quicktasksview_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./quicktasksview/quicktasksview.component */ "./src/app/quicktasksview/quicktasksview.component.ts");
/* harmony import */ var _overdue_overdue_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./overdue/overdue.component */ "./src/app/overdue/overdue.component.ts");
...
const routes = [
    ...
    { path: 'overdue', component: _overdue_overdue_component__WEBPACK_IMPORTED_MODULE_15__["OverdueComponent"] },
    ...
    { path: 'quicktasksview', component: _quicktasksview_quicktasksview_component__WEBPACK_IMPORTED_MODULE_14__["QuicktasksviewComponent"] },
];
...
/* harmony import */ var _quicktasksview_quicktasksview_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./quicktasksview/quicktasksview.component */ "./src/app/quicktasksview/quicktasksview.component.ts");
/* harmony import */ var _overdue_overdue_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./overdue/overdue.component */ "./src/app/overdue/overdue.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _quicktasksview_quicktasksview_component__WEBPACK_IMPORTED_MODULE_22__["QuicktasksviewComponent"],
            _overdue_overdue_component__WEBPACK_IMPORTED_MODULE_23__["OverdueComponent"]
        ],
        imports: [
...
let OverdueComponent = class OverdueComponent {
    constructor(player, router) {
        this.player = player;
        this.router = router;
    }
...
OverdueComponent.ctorParameters = () => [
    { type: _player__WEBPACK_IMPORTED_MODULE_2__["Player"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
OverdueComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-overdue',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./overdue.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/overdue/overdue.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./overdue.component.css */ "./src/app/overdue/overdue.component.css")).default]
    })
], OverdueComponent);
...
let Player = class Player {
    ...
    getOverdueTasks() {
        ...
        for (let x = 0; x < this.player.tasks.length; x++) {
            ...
            let tempDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["parseISO"])(taskDate);
            let result = Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["isPast"])(tempDate);
    ...
    getInboxTasks() {
        let inboxTaskStack = [];
        let startDate = new Date();
        let formattedstartDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["format"])(startDate, 'yyyy-MM-dd');
        for (let x = 0; x < this.player.tasks.length; x++) {
            let taskDate = this.player.tasks[x].due;
            let tempDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["parseISO"])(taskDate);
            let result = Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["isFuture"])(tempDate);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuicktasksviewComponent", function() { return QuicktasksviewComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../player */ "./src/app/player.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let QuicktasksviewComponent = class QuicktasksviewComponent {
    constructor(player, router) {
        this.player = player;
        this.router = router;
    }
...
QuicktasksviewComponent.ctorParameters = () => [
    { type: _player__WEBPACK_IMPORTED_MODULE_2__["Player"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
QuicktasksviewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-quicktasksview',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./quicktasksview.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/quicktasksview/quicktasksview.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./quicktasksview.component.css */ "./src/app/quicktasksview/quicktasksview.component.css")).default]
    })
...
let TaskcreateComponent = class TaskcreateComponent {
    ...
    ngOnInit() {
        ...
        this.route.params.forEach((params) => {
            ...
            else if (this.focustype.typeID == 0) {
